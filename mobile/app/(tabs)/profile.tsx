    ...
    <SafeScreen>
      ...
      >
        ...
        <View className="px-6 pb-8">
          <View className="bg-surface rounded-3xl px-6 py-8 flex gap-4 items-center justify-between">
        ...
        {/* MENU ITEMS */}
        <View className="flex-row flex-wrap gap-2 mx-6 mb-3 items-center justify-center">
          {
            MENU_ITEMS?.map(item => (
              <TouchableOpacity
        ...
        {/* LOGOUT USER */}
        <TouchableOpacity
            className="mx-6 mb-3 bg-surface rounded-2xl flex-row items-center justify-center py-5"
            activeOpacity={0.8}
            onPress={() => signOut()}
          >
            <View
