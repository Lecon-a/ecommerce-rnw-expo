...
export async function addAddress(req, res) {
    try {
        ...
        user.addresses.push({
            ...
            streetAddress, city,
            state, zipCode,
            phoneNumber, isDefault: isDefault || false
        })

        await user.save();
        res.status(201).json({message: "address addes successfully", addresses: user.addresses})
    } catch (error) {
        console.log('====================================');
...
export async function updateAddress(req, res) { 
    try {
        ...
        address.cite = city || address.city;
        address.state = state || address.state;
        address.zipCode = zipCode || address.zipCode;
        address.phoneNumber = phoneNumber || address.phoneNumber;
        address.isDefault = isDefault === undefined ? address.isDefault : isDefault;
...
export async function addToWishlist(req, res) {
    try {
        ...
        // check if the product is alredy in the wishlist
